...
(function (t, e) {
    ...
    t.position = {
        ...
        e = t.extend({}, e);
        var a, p, m, g, v, _, b = t(e.of), y = t.position.getWithinInfo(e.within), w = t.position.getScrollInfo(y),
        ...
        return _ = n(b), b[0].preventDefault && (e.at = "left top"), p = _.width, m = _.height, g = _.offset, v = t.extend({}, g), t.each(["my", "at"], function () {
            ...
            var n, l, c = t(this), u = c.outerWidth(), d = c.outerHeight(), f = s(this, "marginLeft"),
                ...
                T = d + _ + s(this, "marginBottom") + w.height, C = t.extend({}, v),
    ...
    e.widget("ui.draggable", e.ui.mouse, {
        ...
        _generatePosition: function (t) {
            var i, s, n, a, o = this.options,
                ...
                h = /(html|body)/i.test(r[0].tagName), l = t.pageX, u = t.pageY;
